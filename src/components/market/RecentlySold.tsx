    ...
    <div className="md:w-[23%] w-full h-auto rounded-[12px] shadow-md relative group md:mb-0 mb-3">
      <div className="w-full h-[166px] relative">
        ...
        <div className="absolute top-[150px] z-[9999] -left-3">
          <Image
            src={"/assets/images/market/sold.png"}
            width={120}
            height={80}
            alt="popular"
          />
...
export default function NewListing() {
  return (
    <div className=" mt-10 md:w-[85%] w-[95%] m-auto">
      ...
      <div className="my-4 md:flex justify-between md:px-2 px-[2px] items-center md:gap-5 gap-3   overflow-x-auto scrollable py-1">
        {data.map((item, index) => (
