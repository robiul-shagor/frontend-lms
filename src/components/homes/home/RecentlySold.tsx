...
import { fetchSoldPropertyData, fetchMediaPropertyData } from "@/services/api";
...
export default async function NewListing() {
  ...
  try {
    ...
    const response = await fetchSoldPropertyData(); // Ensure this function returns a valid fetch response
